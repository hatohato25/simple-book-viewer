...
class Unarchiver {
  static async load(e = null) {
    return (
      ...
      Promise.all(e.map(Unarchiver._loadFormat))
    );
  }
  static async _loadFormat(t) {
    if (!(t in Unarchiver.loadedFormats)) {
      const a = currentScriptPath();
  ...
  static _isZipFile(e) {
    return Unarchiver._checkHeader([80, 75, 3, 4], e);
  }
  static _isTarFile(e) {
    return Unarchiver._checkHeader([117, 115, 116, 97, 114], e, 257, 512);
  }
  static _isGzip(e) {
    return Unarchiver._checkHeader([31, 139, 8], e);
  }
  static _isBZ2(e) {
    return Unarchiver._checkHeader([66, 90, 104], e);
  }
  static _isXZ(e) {
    return Unarchiver._checkHeader([253, 55, 122, 88, 90, 0], e);
  }
